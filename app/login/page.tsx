    ...
    >
      ...
      <div className="relative z-10 w-full max-w-[500px] flex flex-col items-center animate-in fade-in slide-in-from-bottom-8 duration-1000">
        ...
        <div className="mt-14 flex items-center justify-center gap-4 animate-in fade-in slide-in-from-bottom-4 duration-1000 delay-500">
          <Link href="/admin-login" className="px-8 py-3 bg-white border border-gray-100 rounded-full shadow-sm hover:shadow-md hover:border-blue-200 transition-all text-[10px] font-black uppercase tracking-widest italic text-gray-500 hover:text-blue-600 active:scale-95">
            Admin Governance Node
          </Link>
