  ...
  return (
    <div className="min-h-screen bg-[#050816] text-white">
      ...
      <section className="py-24 px-6 text-center">
        <h1 className="text-5xl font-bold mb-6">About Quizaro</h1>
        <p className="max-w-2xl mx-auto text-lg text-gray-400">
          Quizaro is a smart online platform designed to help students prepare
      ...
      <section className="text-center py-20 px-6">
        ...
        <p className="mb-8 text-lg text-gray-400">
          Join thousands of students preparing smarter with Quizaro.
        </p>
        <Link
          href="/register"
...
function FeatureCard({
  ...
  return (
    <div className="bg-white/5 border border-white/10 p-8 rounded-2xl hover:border-purple-500/40 transition text-center">
...
function Stat({ number, label }: { number: string; label: string }) {
  return (
    <div>
      <h3 className="text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-cyan-400">{number}</h3>
