...
export default function AdminHelpPage() {
  ...
  }, [isDebugActive, bugForm.description]);
                     ...
                     <div className="flex flex-col lg:flex-row gap-20 relative z-10">
                        <div className="flex-1 space-y-8">
                           ...
                           <p className="text-gray-400 font-bold uppercase tracking-widest italic leading-relaxed text-sm">
                              Detected a protocol anomaly? Every submission is logged with a {"{Trace_ID}"} for registry integrity. Metadata (Admin, URL) is attached silently.
                           </p>
                        ...
                        >
                           <div className="grid grid-cols-2 gap-6">
                              <div className="space-y-4">
                                 ...
                                 <select 
                                   className="w-full bg-white/5 border border-white/10 rounded-xl px-6 py-4 text-white font-bold outline-none focus:border-[#3b94ed] transition-all text-sm italic appearance-none"
                           ...
                           <div className="space-y-4">
                              ...
                              <textarea 
                                ...
                                className="w-full bg-white/5 border border-white/10 rounded-xl px-6 py-6 text-white font-bold outline-none focus:border-[#3b94ed] transition-all text-sm italic resize-none"
                           ...
                           <button 
                             ...
                             className="w-full py-6 bg-[#3b94ed] disabled:opacity-50 disabled:cursor-not-allowed text-white rounded-2xl font-black text-[12px] uppercase tracking-widest italic shadow-xl shadow-blue-900/40 hover:scale-[1.02] active:scale-95 transition-all flex items-center justify-center gap-4"
                           >
