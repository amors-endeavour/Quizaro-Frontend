...
export default function AdminFolderCard({ name, count, onClick, onEdit, onDelete }: AdminFolderCardProps) {
  return (
    <div 
      onClick={onClick}
      className="bg-white dark:bg-[#0a0f29] border border-gray-200 dark:border-gray-800 rounded-xl overflow-hidden hover:shadow-md transition-all duration-300 cursor-pointer flex flex-col group relative active:scale-[0.98]"
    >
      {/* Folder Icon Section */}
      <div className="flex-1 flex items-center justify-center py-12 bg-gray-50/30 dark:bg-gray-800/30">
      ...
      {/* Name Section */}
      <div className="bg-white dark:bg-gray-900 border-t border-gray-100 dark:border-gray-800 px-6 py-4 flex items-center justify-center text-center min-h-[70px]">
        <h3 className="text-[11px] font-bold text-gray-700 dark:text-gray-100 uppercase tracking-wider leading-tight">
          {name}
        </h3>
      </div>
